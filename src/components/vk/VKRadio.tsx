    ...
    return (
      <label className={`inline-flex items-center gap-vk-2 cursor-pointer ${className}`}>
        <input
          ref={ref}
          type="radio"
          className={`w-5 h-5 border-2 border-vk-border bg-vk-bg text-vk-accent-blue focus:ring-2 focus:ring-vk-accent-blue focus:ring-offset-1 transition-all duration-vk-base ${
