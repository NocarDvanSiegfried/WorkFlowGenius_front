...
export function DollarSignIcon({ className = 'w-6 h-6' }: DollarSignIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
